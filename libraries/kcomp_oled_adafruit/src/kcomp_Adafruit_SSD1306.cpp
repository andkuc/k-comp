// quickly modified for testing purpose; do not use this code unless for kcomp prototype 1
// - architectures other than avr removed
// spi removed
// some other mods
...
#include <kcomp_Adafruit_SSD1306.h>
#include <splash.h>
#include <kcomp_Adafruit_GFX.h>
...
*/
Adafruit_SSD1306::Adafruit_SSD1306(TwoWire *twi, uint32_t clkDuring,
                                   uint32_t clkAfter)
    : Adafruit_GFX(SCREEN_WIDTH, SCREEN_HEIGHT), wire(&Wire), buffer(NULL), 
      rstPin(OLED_RESET), wireClk(clkDuring), restoreClk(clkAfter)
{
}
...
bool Adafruit_SSD1306::begin() {
  ...
  ssd1306_command1((SSD1306_SWITCHCAPVCC == SSD1306_EXTERNALVCC) ? 0x10 : 0x14);
  ...
  comPins = 0x12;
  contrast = (SSD1306_SWITCHCAPVCC == SSD1306_EXTERNALVCC) ? 0x9F : 0xCF;
  ...
  ssd1306_command1((SSD1306_SWITCHCAPVCC == SSD1306_EXTERNALVCC) ? 0x22 : 0xF1);
